...
library(readxl)
Life_expectancy_at_birth_1 <- read_excel("C:/Users/ibrsa/Desktop/İTÜ/2020-2021 BAHAR YARIYILI/MAT 381E/final_docs-sahinibr17/data/Life_expectancy_at_birth_1.xlsx")
